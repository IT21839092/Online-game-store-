...
<table class="tab1" border="2" width="100%">
		...
		<th>
			<img class="Logo" src="img/logo.jpg"width="50px"height="50px" align="left">
				...
				<a class="set6" href="fromproject1.php"><img src="img/user.jpg"width="25px"height="25px"></a>
				<a class="set7" href="cart.php"><img src="img/cart1.jpg"width="25px"height="25px"></a>
...
<input type="txt" name="fname" id="fname" class="menu6" placeholder="USER NAME" ></h3><br><br>
<h3><label>PASSWORD</label>
<input type="password" name="paw" id="paw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,10}" class="menu6" placeholder="PASSWORD" ></h3><br><br>
...
<br><br>
<button name="btn2" class="menu7"><a href="fromproject1.html" style="text-decoration:none;color:white;">SING UP</a></button><br><br>
