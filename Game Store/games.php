   ...
   <table class="tab1" border="2" width="100%">
		...
		<th>
			<img class="Logo" src="img/logo.jpg"width="50px"height="50px" align="left">
				...
				<p>KIDHERO</p>
				<a class="set1" href="homePage.html">Home</a>
...
<button style="background-color:black;color:white;"><a href="game-store.php">Add game</a></button>
<!---------------------------------------------------- BODY SECTION ---------------------------------------------------------->
            ...
            <div class="game-container col-md-4 px-4 pt-3">
               <div class="game-card">
                  <div style="min-height: 240px;" class="d-flex">
                     <img src="img/<?php echo "{$row['image']}" ?>" alt="" style="width:100%; max-height: 240px;">
                  </div>
                  ...
                  <a href="#"><button href="policy1.html">Add to Cart</button></a>
               </div>
            </div>
